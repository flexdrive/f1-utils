(function (global, factory) {
	...
	var Errors = {
	  ...
	  ERROR_MOBILE_SERVICE_SUBSCRIBE_PICKUP_DATE_IN_THE_PAST: 'ERROR_MOBILE_SERVICE_SUBSCRIBE_PICKUP_DATE_IN_THE_PAST',
	  ERROR_MOBILE_SERVICE_DEALER_NOT_TAKING_NEW_SUBSCRIPTIONS: 'ERROR_MOBILE_SERVICE_DEALER_NOT_TAKING_NEW_SUBSCRIPTIONS',
	  ERROR_COULD_NOT_ESTIMATE_SUBSCRIPTION_COST: 'ERROR_COULD_NOT_ESTIMATE_SUBSCRIPTION_COST',
	  ERROR_MOBILE_SERVICE_COULD_NOT_ESTIMATE_SUBSCRIPTION_COST: 'ERROR_MOBILE_SERVICE_COULD_NOT_ESTIMATE_SUBSCRIPTION_COST',
	  ERROR_NO_FILE_CONTENT: 'ERROR_NO_FILE_CONTENT',
	  ERROR_MISSING_CONTENT_TYPE: 'ERROR_MISSING_CONTENT_TYPE',
	  ERROR_ASSET_SERVICE_CANNOT_FIND_THE_REQUESTED_FILE: 'ERROR_ASSET_SERVICE_CANNOT_FIND_THE_REQUESTED_FILE',
	  ...
	  LOCATION_NOT_FOUND: 'ERROR_LOCATION_NOT_FOUND',
	  MARKET_NOT_FOUND: 'ERROR_MARKET_NOT_FOUND',
	  ERROR_CREATING_VEHICLE_WITH_VIN: 'ERROR_CREATING_VEHICLE_WITH_VIN',
	...
	var index$1 = /*#__PURE__*/Object.freeze({
		...
		LANGUAGES_SETTINGTYPE: LANGUAGES_SETTINGTYPE
	});
	...
	var getStateSchema = function getStateSchema(_ref) {
	  ...
	  return ['US', 'CA'].indexOf(country) > -1 ? lib_6().trim().required('A state is required').max(2, 'State/Province codes cannot be more than 2 characters long') : lib_6().ensure();
	};
	...
	function getAddressSchema(values) {
	  return lib_9().shape({
	    address1: lib_6().trim().max(255).required(),
	    address2: lib_6().trim().max(255),
	    city: lib_6().trim().max(255),
	    state: getStateSchema(values),
	    zip: getZipSchema(values),
	    country: lib_6().trim().max(2)
	  });
	}
